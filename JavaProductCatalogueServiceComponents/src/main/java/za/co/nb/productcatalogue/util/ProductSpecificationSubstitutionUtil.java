...
import za.co.nb.productcatalogue.handlers.BaseProductSpecificationRuleHandler;
...
public class ProductSpecificationSubstitutionUtil {
    ...
    private BaseProductSpecificationRuleHandler getProductSubstitutionRuleHandler(String productSpecificationID) {
		...
		try {
			Class theClass = Class.forName("za.co.nb.productcatalogue.handlers.RuleHandler" + productSpecificationID);
